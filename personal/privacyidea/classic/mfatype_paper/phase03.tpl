...
<table style="width: 100%" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td style="vertical-align: middle; padding-left: 5px">{t escape=no 1=$tokenDescription}The TAN list <b>%1</b> was successfully added to this account and can now be used.{/t}</td>
    </tr>
</table>
