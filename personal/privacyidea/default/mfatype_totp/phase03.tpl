...
Authentifizierungsapp hinzugefügt

Die Authentifizierungsapp $BESCHREIBUNG wurde erfolgreich zu Ihrer Uni-ID hinzugefügt und kann ab sofort genutzt werden.
